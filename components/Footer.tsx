  ...
  return (
    <footer className="bg-[#fdfbf9] border-t border-accent-light/50 py-6 px-8 text-foreground/70 text-sm">
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-6 mb-4">
        ...
        <div>
          <div className="flex items-center gap-2 mb-6">
            ...
            <span className="text-xl font-bold tracking-wide text-foreground">Glam Grid</span>
          </div>
        ...
        <div>
          ...
          <ul className="space-y-2">
            <li><Link href="/ai-stylist" className="hover:text-accent transition-colors">AI Personal Stylist</Link></li>
            <li><Link href="#" className="hover:text-accent transition-colors">Find Local Salons</Link></li>
            <li><Link href="#" className="hover:text-accent transition-colors">Book Photo Studios</Link></li>
            <li><Link href="#" className="hover:text-accent transition-colors">Shop Accessories</Link></li>
          </ul>
        </div>
        ...
        <div>
          ...
          <ul className="space-y-2">
            <li><Link href="#" className="hover:text-accent transition-colors">Trending Outfits</Link></li>
            <li><Link href="#" className="hover:text-accent transition-colors">Bridal Makeup Ideas</Link></li>
            <li><Link href="#" className="hover:text-accent transition-colors">Beautiful Locations</Link></li>
            <li><Link href="#" className="hover:text-accent transition-colors">Style Blog</Link></li>
          </ul>
        </div>
      ...
      <div className="max-w-7xl mx-auto border-t border-accent-light/50 pt-8 text-center text-sm flex flex-col md:flex-row justify-between items-center gap-4">
        <p>© 2026 Glam Grid Fashion. All rights reserved.</p>
